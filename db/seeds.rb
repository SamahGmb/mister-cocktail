...
regis = User.create!(email:'regis@gmail.com', password:'RegisRegis')
...
mai_tai = Cocktail.create!(name:'Mai Tai', user:michel, description:"The Mai Tai is a Polynesian-style cocktail that has a fruity tropical taste sweet and vibrant. The mixture of light and dark rum, orange curacao, orgeat syrup and lime juice has been a symbol of Tahitian culture ever since the drink was first created.")
mint_julep = Cocktail.create!(name:'Mint Julep', user:michel, description:"The concoction of Bourbon, a little bit of water, powdered and granulated sugar and plenty of mint has long been a very popular way to drink a cocktail. Simple yet refined.")
caipirinha = Cocktail.create!(name:'Caipirinha', user:michel, description:"Originally based on a remedy to cure Spanish flu, the national drink of Brazil is made with cachaca (spirit from a sugar cane) or white rum/vodka, brown sugar and lime juice.")
